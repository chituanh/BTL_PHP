                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="index.php?page_layout=sua&id=<?php echo $row['idMonHoc']; ?>">Sửa</a>
                                <a onclick="return Del('<?php echo $row['nameMonHoc']; ?>')" class="btn btn-danger" href="index.php?page_layout=xoa&id=<?php echo $row['idMonHoc']; ?>">Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
